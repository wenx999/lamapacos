...
public class SegmentFilter extends Configured implements Reducer<Text, NutchWritable, Text, NutchWritable> {
...
//	}
	...
	public void reduce(Text key, Iterator<NutchWritable> values, OutputCollector<Text, NutchWritable> output, Reporter reporter) throws IOException {
...
//				output.collect(key, (NutchWritable) value);
